...
{
public:
	RotatingComponent(dae::GameObject* pOwner);
	RotatingComponent(dae::GameObject* pOwner, float radius) : RotatingComponent(pOwner){ m_radius = radius / 100; };
	RotatingComponent(dae::GameObject* pOwner, float radius, float speed) : RotatingComponent(pOwner, radius) { m_speed = speed; };
