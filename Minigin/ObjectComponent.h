...
public:
	ObjectComponent(std::shared_ptr<dae::GameObject>& pOwner);
	...
	void InitializeOwner(std::shared_ptr<dae::GameObject>& pOwner);
...
protected:
	...
	void BasicRender(dae::Texture2D* pTexture) const;
};
